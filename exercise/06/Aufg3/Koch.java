/* Rechnerarchitektur und Betriebssysteme �bung 4
    ...
    Hier gar nichts �ndern! (gilt nur f�r Aufgabe 1!)
*/
    ...
    public void run () {
        ...
        while (true) {
            ...
            for (int i=0; i<gerichte.length; i++) {
                gerichte[i] = new String(repertoire[r]);
                count += 1;

                if (count == 50) {
                    System.out.println("(" + System.currentTimeMillis() + ")" +" Koch: Feierabend");
                    return;
                }

            }
            
            System.out.println ("(" + System.currentTimeMillis() + ")" +" Koch: " + gerichte[0] + " zubereitet: en Guete! Noch " + (50-count) + " bis feierabend");
            mensa.put (gerichte);
        }
    }
}
